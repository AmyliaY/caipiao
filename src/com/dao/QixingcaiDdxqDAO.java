...
/**
 	* A data access object (DAO) providing persistence and search support for QixingcaiDdxq entities.
 			* Transaction control of the save(), update() and delete() operations 
		can directly support Spring container-managed transactions or they can be augmented	to handle user-managed Spring transactions. 
		Each of these methods provides additional information for how to configure it for the desired type of transaction control. 	
	 * @see com.pojo.QixingcaiDdxq
  * @author MyEclipse Persistence Tools 
 */
public class QixingcaiDdxqDAO extends HibernateDaoSupport  {
	     private static final Logger log = LoggerFactory.getLogger(QixingcaiDdxqDAO.class);
		//property constants
    ...
    public void save(QixingcaiDdxq transientInstance) {
        log.debug("saving QixingcaiDdxq instance");
        try {
	...
	public void delete(QixingcaiDdxq persistentInstance) {
        log.debug("deleting QixingcaiDdxq instance");
        try {
    ...
    public QixingcaiDdxq findById( java.lang.Integer id) {
        log.debug("getting QixingcaiDdxq instance with id: " + id);
        try {
            QixingcaiDdxq instance = (QixingcaiDdxq) getHibernateTemplate()
                    .get("com.pojo.QixingcaiDdxq", id);
            return instance;
        } catch (RuntimeException re) {
    ...
    public List findByExample(QixingcaiDdxq instance) {
        log.debug("finding QixingcaiDdxq instance by example");
        try {
    ...
    public List findByProperty(String propertyName, Object value) {
      log.debug("finding QixingcaiDdxq instance with property: " + propertyName
            + ", value: " + value);
      try {
         String queryString = "from QixingcaiDdxq as model where model." 
         						+ propertyName + "= ?";
	...
	public List findAll() {
		log.debug("finding all QixingcaiDdxq instances");
		try {
			String queryString = "from QixingcaiDdxq";
    ...
    public QixingcaiDdxq merge(QixingcaiDdxq detachedInstance) {
        log.debug("merging QixingcaiDdxq instance");
        try {
            QixingcaiDdxq result = (QixingcaiDdxq) getHibernateTemplate()
    ...
    public void attachDirty(QixingcaiDdxq instance) {
        log.debug("attaching dirty QixingcaiDdxq instance");
        try {
    ...
    public void attachClean(QixingcaiDdxq instance) {
        log.debug("attaching clean QixingcaiDdxq instance");
        try {
	...
	public static QixingcaiDdxqDAO getFromApplicationContext(ApplicationContext ctx) {
    	return (QixingcaiDdxqDAO) ctx.getBean("QixingcaiDdxqDAO");
	}
}