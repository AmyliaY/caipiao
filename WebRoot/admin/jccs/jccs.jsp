...
<div class="pd-20">
    ...
    <div class="row cl">
      ...
      <div class="formControls col-5" id="zzzz">
        <input type="text" class="input-text" onblur="yz_name()" value="${map.jifen}" placeholder="" id="jifen" name="jifen">
      </div>
      <div class="col-4" id="nono"> </div>
    </div>
    <div class="row cl">
      <div class="col-9 col-offset-3">
        <input class="btn btn-primary radius" id="sub" onclick="return yz_tiaojiao()" type="submit" value="&nbsp;&nbsp;设置&nbsp;&nbsp;">
      </div>
    </div>
    </div>
</div>
