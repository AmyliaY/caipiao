...
<body>
	...
	<form action="/caipiao-web/userscaiwu.do?p=xiaofeitijiao" method="post">
		...
		<div class="col-2">
			<p style="line-height: 30px;vertical-align: middle;">注数：</p>
		</div>
		<div class="col-10">
		...
		<div class="col-2">
			<p style="line-height: 30px;vertical-align: middle;">消费金额：</p>
		</div>
		<div class="col-10">
