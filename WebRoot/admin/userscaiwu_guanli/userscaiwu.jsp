...
<![endif]-->
  ...
  <nav class="breadcrumb">
		...
		<span class="c-gray en">&gt;</span> 用户财务
					...
					<tbody>
						<c:forEach items="${map.list}" var="a" varStatus="i">
							<tr class="text-c">
								...
								<td>
									<a href="javascript:;" onclick="userscaiwu_update('用户信息修改','${pageContext.request.contextPath}/userscaiwu.do?p=usercaiwu_bianji&id=${a.id }','800','550')">编辑</a>
								</td>
							</tr>
						</c:forEach>
					</tbody>
							...
							<table width="100%" border="0" align="center" cellpadding="0"
								...
								<tr>
									<td width="50%">
										...
										共
										<span class="right-text09">${map.pagecount }</span> 页
									</td>
									<td width="32%" align="right" id="xiugaitype">
										[
										<a
											href="${pageContext.request.contextPath}/userscaiwu.do?p=userscaiwu"
											class="right-font08">首页</a> |
										<a
											href="${pageContext.request.contextPath}/userscaiwu.do?p=userscaiwu&page=${map.page-1}"
											class="right-font08">上一页</a> |
										<a
											href="${pageContext.request.contextPath}/userscaiwu.do?p=userscaiwu&page=${map.page+1}"
											class="right-font08">下一页</a> |
										<a
											href="${pageContext.request.contextPath}/userscaiwu.do?p=userscaiwu&page=${map.pagecount}"
...
function viewGo()
{
		...
		if(page.match('^[0-9]*$'))
		{	
			window.location.href="${pageContext.request.contextPath}/userscaiwu.do?p=userscaiwu&page="+page;
		}
}
function userscaiwu_update(title,url,w,h){
