					...
					<tbody>
						<c:forEach items="${caipiaodianshenhemap.list}" var="a" varStatus="i">
							<tr class="text-c">
								...
								<td>
								<c:if test="${a.zhuangtai==0}">
								<a href="${pageContext.request.contextPath}/caipiaodian.do?p=shenhetongyi&zhuangtai=1&page=${caipiaodianshenhemap.page}&id=${a.id}" class="label label-success radius">同意</a>
								<a href="${pageContext.request.contextPath}/caipiaodian.do?p=shenhejvjueliyou&zhuangtai=2&page=${caipiaodianshenhemap.page}&id=${a.id}" class="label label-default radius">不同意</a>
								</c:if>
								</td>
							</tr>
						</c:forEach>
