	...
	<article class="page-container">
		<form class="form form-horizontal" id="form-qiuhao-add">
				...
				<div class="formControls col-xs-4 col-sm-4">
					<input type="text"
						onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})"
						 name="time" class="input-text Wdate"
						value="${dingdan.time }">
				</div>
			</div>
			<div class="row cl">
				...
				<div class="formControls col-xs-4 col-sm-4">
					<input type="text" name="phone"
						class="input-text" value="${dingdan.users.phone }">
				</div>
			</div>
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-4"><span
				...
				<div class="formControls col-xs-4 col-sm-4">
					<input type="text" name="money"
						class="input-text" value="${dingdan.money }">
				</div>
			</div>
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-4"><span
				...
				<div class="formControls col-xs-4 col-sm-4">
					<input type="text" name="num"
						class="input-text" value="${dingdan.num }">
				</div>
			</div>
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-4"><span
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-4 col-sm-4">
					<select name="jiedancpd1"
						class="input-text" id="jiedancpdid1">
					</select>
				</div>
			</div>
			<div class="row cl">
				...
				<div class="formControls col-xs-4 col-sm-4">
					<select name="jiedancpd2"
						class="input-text" id="jiedancpdid2">
					</select>
				</div>
			</div>
			<div class="row cl">
				...
				<div class="formControls col-xs-4 col-sm-4">
					<select name="jiedancpd3"
						class="input-text" id="jiedancpdid3">
					</select>
				</div>
			</div>
			<div class="row cl">
				...
				<div class="formControls col-xs-4 col-sm-4">
					<select name="jiedancpd4"
						class="input-text" id="jiedancpdid4">
					</select>
				</div>
			</div>
			<div class="row cl">
				...
				<div class="formControls col-xs-4 col-sm-4">
					<select name="jiedancpd5"
						class="input-text" id="jiedancpdid5">
					</select>
				</div>
			</div>
			<div class="row cl">
				...
				<div class="formControls col-xs-4 col-sm-4">
					<select name="shijizhongbiaocpd"
						class="input-text" id="shijizhongbiancpdid">
					</select>
				</div>
			</div>
			<div class="row cl">
