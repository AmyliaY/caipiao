					...
					<tbody>
						<c:forEach items="${map.list}" var="a" varStatus="i">
							<tr class="text-c">
								...
								<td>
									<a href="${pageContext.request.contextPath}/users.do?p=userlisting_biji&id=${a.id}" class="label label-success radius">
									编辑
									</a>
								</td>
							</tr>
							...
							<table width="100%" border="0" align="center" cellpadding="0"
								...
								<tr>
									...
									<td width="32%" align="right" id="xiugaitype">
										[
										<a
											href="${pageContext.request.contextPath}/users.do?p=userlisting"
											class="right-font08">首页</a> |
										<a
											href="${pageContext.request.contextPath}/users.do?p=userlisting&page=${map.page-1}"
											class="right-font08">上一页</a> |
										<a
											href="${pageContext.request.contextPath}/users.do?p=userlisting&page=${map.page+1}"
											class="right-font08">下一页</a> |
										<a
											href="${pageContext.request.contextPath}/users.do?p=userlisting&page=${map.pagecount}"
...
function viewGo()
{
		...
		if(page.match('^[0-9]*$'))
		{	
			window.location.href="${pageContext.request.contextPath}/users.do?p=userlisting&page="+page;
		}
}
