...
/**
 	* A data access object (DAO) providing persistence and search support for Collections entities.
...
public class CollectionsDAO extends HibernateDaoSupport  {
	     private static final Logger log = LoggerFactory.getLogger(CollectionsDAO.class);
		//property constants
    ...
    public Collections findById( java.lang.Integer id) {
        ...
        try {
            Collections instance = (Collections) getHibernateTemplate()
                    .get("com.pojo.Collections", id);
            return instance;
        } catch (RuntimeException re) {
    ...
    public Collections merge(Collections detachedInstance) {
        ...
        try {
            Collections result = (Collections) getHibernateTemplate()
	...
	public static CollectionsDAO getFromApplicationContext(ApplicationContext ctx) {
