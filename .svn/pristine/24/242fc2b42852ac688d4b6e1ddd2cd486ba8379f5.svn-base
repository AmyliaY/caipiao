...
<div class="page-container">
	<form action="${pageContext.request.contextPath}//caipiao.do?p=xuangseqiulisting" method="post" name="f" id="f" autocomplete="off">
	...
	<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"> <a href="javascript:;" onclick="qiuhao_add('球号入库','${pageContext.request.contextPath}/caipiao.do?p=getMaxQishu','800','550')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 球号入库</a></span>
	...
	<table class="table table-border table-bordered table-hover table-bg table-sort">
		...
		<c:forEach items="${kaijiangmap.list}" var="cz" varStatus="i" >
			<tr class="text-c">	
				...
				<td><fmt:formatDate value="${cz.kaijiangTime}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
				<td>${cz.qihao}</td>
				<td>${cz.hongqiu1}</td>
				<td>${cz.hongqiu2}</td>
				<td>${cz.hongqiu3}</td>
				...
				<td>${cz.hongqiu6}</td>
				<td>${cz.lanqiu}</td>
				<td><a href="javascript:;" onclick="kaijiang_update('修改开奖纪录','${pageContext.request.contextPath}/caipiao.do?p=getKaiJiangById&id=${cz.id }','800','550')">编辑</a></td>
			</tr>
			</c:forEach>
		</tbody>
	</table>
