...
<body>
	...
	门店财务 <a class="btn btn-success radius r mr-20"
					...
					<c:forEach items="${map.list}" var="a" varStatus="i">
						<tr class="text-c">
							...
							<td><a href="javascript:;"
								onclick="storescaiwu_update('门店信息修改','${pageContext.request.contextPath}/userscaiwu.do?p=storescaiwu_bianji&id=${a.id }','800','550')">编辑</a>
							</td>
						</tr>
					</c:forEach>
				</tbody>
...
function storescaiwu_update(title,url,w,h){
