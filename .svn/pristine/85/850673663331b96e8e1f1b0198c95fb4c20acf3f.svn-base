...
<body>
   ...
   <div class="login_center">
         ...
         <div class="login_users">
               ...
               <form target="_top" action="${pageContext.request.contextPath }/adminlogin.do?p=tomain" method="post">
               <table>
                   ...
                   <tr>
                      ...
                      <td><b class="login_txt2"><input type="text" name="yzm" class="txtyzm" placeholder="请输入验证码"/></b><img alt="验证码" src="${pageContext.request.contextPath}/yzm.do?p=getCode" class="txtimg" id="txtimg" /></td>
                   </tr>
                   <tr>
