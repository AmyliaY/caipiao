...
<body>
	...
	<div class="page-container">
		<form
			action="${pageContext.request.contextPath}//cpdchongzhirecord.do?p=cpdchongzhilisting"
					...
					<c:forEach items="${map.list}" var="cz" varStatus="i">
						<tr class="text-c">
							...
							<td><a href="javascript:;"
								onclick="chongzhijilu_update('修改开奖纪录','${pageContext.request.contextPath}/cpdchongzhirecord.do?p=cpdgetChongzhijiluById&id=${cz.id }','800','550')">编辑</a></td>
						</tr>
					</c:forEach>
				</tbody>
			</table>
