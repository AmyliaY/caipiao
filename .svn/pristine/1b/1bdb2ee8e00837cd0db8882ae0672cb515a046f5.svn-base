...
/**
 * QixingcaiDdxq entity. @author MyEclipse Persistence Tools
 */

public class QixingcaiDdxq  implements java.io.Serializable {
    ...
    /** default constructor */
    public QixingcaiDdxq() {
    }

    
    /** full constructor */
    public QixingcaiDdxq(Dingdan dingdan, CaipiaobiaoDesc caipiaobiaoDesc, String num1, String num2, String num3, String num4, String num5, String num6, String num7, Integer zhushu, Integer beishu, Integer isZhongjiang, Double zhongjiangjine, Integer isLingjiang, Double payMoney) {
