...
<body>
	...
	<div class="pd-20">
		<div class="cl pd-5 bg-1 bk-gray mt-20">
			...
			</span> <span class="r">共有数据：<strong id = "sum">${caipiaodianmap.sum}</strong> 条
			</span>
		</div>
		<div class="mt-20">
			<table id="tab"
					...
					<td height="33">
						<table width="100%" border="0" align="center" cellpadding="0"
							...
							<tr>
								...
								<td width="32%" align="right" id="xiugaitype">[ <button
									
									class="right-font08" id="shouye">首页</button> | <button
									
									class="right-font08" id="last">上一页</button> | <button
									
									class="right-font08" id="next">下一页</button> | <button
									
									class="right-font08" id="moye">末页</button> ] 转至：
								</td>
								<td width="5%">
