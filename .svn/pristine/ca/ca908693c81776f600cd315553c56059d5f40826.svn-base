...
/**
 * PailiesanDdxq entity. @author MyEclipse Persistence Tools
 */

public class PailiesanDdxq  implements java.io.Serializable {
    ...
    /** default constructor */
    public PailiesanDdxq() {
    }

    
    /** full constructor */
    public PailiesanDdxq(Dingdan dingdan, CaipiaobiaoDesc caipiaobiaoDesc, String num1, String num2, String num3, Integer zhushu, Integer beishu, Integer isZhongjiang, Double zhongjiangjine, Integer isLingjiang, Double payMoney) {
